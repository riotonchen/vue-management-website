  ...
  data () {
    return {
      ...
      table_checkResult: [
        ...
        {
          checkItem: '操作系统',
          details: '工作机和灾备机的操作系统版本相同，工作机的操作系统是：Microsoft Windows Server 2008 R2/x64 Edition/Service Pack1，灾备机的操作系统是：Microsoft Windows Server 2008 R2/x64 Edition/Service Pack1'
        },
        {
          checkItem: '磁盘映射',
          details: '灾备机包含了工作机需要迁移的全部盘符：C：；工作机的盘符列表为C：,灾备机的盘符列表为C：；'
        },
        {
          checkItem: '旧的规则',
